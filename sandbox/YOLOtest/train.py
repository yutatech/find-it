...
base_model = YOLO('/home/shingo/find-it/sandbox/YOLOtest/runs/detect/yolov8n_finetuned5/weights/last.pt')  # デフォルトYOLOモデル (例: YOLOv8 Nano)

# 新しいデータセットで追加学習
results = base_model.train(
    data= r'/mnt/c/Users/shingo/YOLO/watch2/data.yaml',  # 新しいデータセットのdata.yaml
    epochs=10,  # 追加学習するエポック数
    lr0=0.001,
    batch=16,
    augment=True,
    imgsz=640,  # 画像サイズ
    ...
    pretrained='/home/shingo/find-it/sandbox/YOLOtest/runs/detect/yolov8n_finetuned5/weights/last.pt',  # 事前学習済みモデルを活用
)
